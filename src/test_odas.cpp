...
static void fill_and_publish_pose(double pitch, double yaw, double E) {
...
void increase_pots() {
  ...
  fill_and_publish_pose(0, atan2(y,x), E);
...
int main(int argc, char *argv[]) {
  ...
  while ((messageSize = recv(connection_id, message, nBytes, 0)) > 0 && ros::ok()) {
